...
namespace MoneyPlan.API.Tests._Helpers
{
    ...
    public class UnitTestContext : IDisposable
    {
        ...
        public IProjectionCalculator ProjectionCalculator => serviceProvider.GetRequiredService<ProjectionCalculator>();

        public ReportService ReportService => serviceProvider.GetRequiredService<ReportService>();
