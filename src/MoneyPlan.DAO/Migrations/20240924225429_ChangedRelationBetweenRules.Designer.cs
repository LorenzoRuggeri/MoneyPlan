...
namespace Savings.DAO.Migrations
{
    ...
    [Migration("20240924225429_ChangedRelationBetweenRules")]
    partial class ChangedRelationBetweenRules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Savings.Model.BudgetPlanBudgetRules", b =>
                {
                    ...
                    b.Property<int>("BudgetPlansId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("RulesID")
                        .HasColumnType("INTEGER");

                    b.Property<int>("RulesID1")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("BudgetPlansId", "RulesID")
                        .IsUnique();
            ...
            modelBuilder.Entity("Savings.Model.BudgetPlan", b =>
                {
                    b.HasOne("Savings.Model.BudgetPlanRule", null)
            ...
            modelBuilder.Entity("Savings.Model.BudgetPlanBudgetRules", b =>
                {
                    b.HasOne("Savings.Model.BudgetPlan", "BudgetPlans")
                        .WithMany("Rules")
                        .HasForeignKey("RulesID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Savings.Model.BudgetPlanRule", "Rules")
                        .WithMany()
                        .HasForeignKey("RulesID1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
